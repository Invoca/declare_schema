...
RSpec.describe 'DeclareSchema Migration Generator' do
  before :all do
    ...
    ActiveRecord::Base.connection.execute("DROP TABLE ads") rescue nil
    ActiveRecord::Base.connection.execute("DROP TABLE adverts") rescue nil
    ActiveRecord::Base.connection.execute("DROP TABLE fancy_adverts") rescue nil
    ActiveRecord::Base.connection.execute("DROP TABLE super_fancy_adverts") rescue nil
    ActiveRecord::Base.connection.execute("DROP TABLE advertisements") rescue nil
    ActiveRecord::Base.connection.execute("DROP TABLE categories") rescue nil
    ActiveRecord::Base.connection.execute("DROP TABLE users") rescue nil
  end
  ...
  it 'generates migrations' do
    ...
    instance_exec do
      ...
      instance_exec do
        ...
        nuke_model_class(Advert) #.field_specs.clear # not normally needed
        class Advert < ActiveRecord::Base
          fields do
